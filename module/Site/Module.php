...
class Module
{
    ...
    public function userAuth(MvcEvent $e)
    {
    	...
    	if($matchedRouteName == 'site') {
    		...
    		header("Location: https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx536a9272e58807e7&redirect_uri=http%3A%2F%2Fwxs.fucmsweb.com%2Fget-user-code&response_type=code&scope=snsapi_base&state=gavin#wechat_redirect");
    		exit(0);
    	}
    }
}