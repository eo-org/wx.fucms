...
include_once (BASE_PATH ."/wx.fucms/html/WxEncrypt/sha1.php");
include_once (BASE_PATH ."/wx.fucms/html/WxEncrypt/xmlparse.php");
include_once (BASE_PATH ."/wx.fucms/html/WxEncrypt/pkcs7Encoder.php");
include_once (BASE_PATH ."/wx.fucms/html/WxEncrypt/errorCode.php");

/**
 * 1.绗笁鏂瑰洖澶嶅姞瀵嗘秷鎭粰鍏紬骞冲彴锛�
 * 2.绗笁鏂规敹鍒板叕浼楀钩鍙板彂閫佺殑娑堟伅锛岄獙璇佹秷鎭殑瀹夊叏鎬э紝骞跺娑堟伅杩涜瑙ｅ瘑銆�
 */
class WXBizMsgCrypt
{
	private $token;
	...
	/**
	 * 鏋勯�犲嚱鏁�
	 * @param $token string 鍏紬骞冲彴涓婏紝寮�鍙戣�呰缃殑token
	 ...
	 * @param $postData string 瀵嗘枃锛屽搴擯OST璇锋眰鐨勬暟鎹�
	 * @param &$msg string 瑙ｅ瘑鍚庣殑鍘熸枃锛屽綋return杩斿洖0鏃舵湁鏁�
	 *
	 * @return int 鎴愬姛0锛屽け璐ヨ繑鍥炲搴旂殑閿欒鐮�
	 */
